...
public class TicketSystem extends JFrame {
	...
	public TicketSystem() {
		...
		totalCostPanel.setBorder(new TitledBorder(new LineBorder(new Color(100, 149, 237), 2, true), " Total Cost ", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(30, 144, 255)));
